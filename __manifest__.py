# -*- coding: utf-8 -*-
{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'sale_stone_workshop_integration/static/src/components/workshop_chain/workshop_chain_validation.js',
            'sale_stone_workshop_integration/static/src/components/workshop_chain/workshop_chain_wizard.js',
