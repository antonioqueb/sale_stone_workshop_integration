...
class SaleOrderLine(models.Model):
    ...
    # ---------------------------------------------------------------------
    # Default propagation from product final → sale line
    # ---------------------------------------------------------------------
    ...
    def _stone_workshop_prepare_create_vals(self, vals):
        ...
        # No machacar valores enviados explícitamente por el cliente web/API.
    ...
    # ---------------------------------------------------------------------
    # Supply decision and creation helpers
    # ---------------------------------------------------------------------
    ...
    def _stone_workshop_needs_supply(self):
        ...
        rounding = self.product_uom.rounding or self.product_id.uom_id.rounding or 0.00001
